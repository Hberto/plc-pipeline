...
cqlsh cassandra -u cassandra -p cassandra -e "CREATE TABLE IF NOT EXISTS test.test (topic text, value int, current_timestamp timestamp, timestamp timestamp, PRIMARY KEY ((topic), timestamp));"
