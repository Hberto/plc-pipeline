package PLC4X_Connector.connection;
...
/**
 * This class handles the PLC4X_Connector.PLC4X_Connector.connection to a driver.
...
public class ConnectionHandler implements IConnector {
     ...
     * @param driverManager driverManager for the PLC4X_Connector.PLC4X_Connector.connection.
     */
    ...
    public PlcConnection connect(boolean simple) {
        ...
        try {
            ...
            log.error("No Connection at ConnectionHandler", e);
        }
        return con;
    }
