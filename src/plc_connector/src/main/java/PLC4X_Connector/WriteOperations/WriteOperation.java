...
public class WriteOperation implements IWritePLC {
    ...
    public void writeSingleField(String itemName, String fieldAdr, String dataType, String value) {
        ...
        try {
            ...
            log.error("Writing in single Data Operation failed", e);
        }
    }
    ...
    private void checkMetaData() {
        if(!con.getMetadata().canWrite()) {
            log.error("This connection doesn't support writing.");
        }
    }

    /**
     * Iterates through Fields with their addresses and values to add them to a write request
