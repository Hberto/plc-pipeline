...
public class PLCData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static producer.PLCData.Builder newBuilder() {
    return new producer.PLCData.Builder();
  }
   ...
   * @return A new PLCData RecordBuilder
   */
  public static producer.PLCData.Builder newBuilder(producer.PLCData.Builder other) {
    return new producer.PLCData.Builder(other);
  }
   ...
   * @return A new PLCData RecordBuilder
   */
  public static producer.PLCData.Builder newBuilder(producer.PLCData other) {
    return new producer.PLCData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PLCData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(producer.PLCData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(producer.PLCData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.orderNr)) {
        this.orderNr = data().deepCopy(fields()[0].schema(), other.orderNr);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder setOrderNr(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder clearOrderNr() {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder setSenderName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder clearSenderName() {
      sender_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder setOperation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder clearOperation() {
      operation = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder setDataType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder clearDataType() {
      data_type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder setData(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public producer.PLCData.Builder clearData() {
